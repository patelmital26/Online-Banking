...
namespace OnlineBankingWebApplication.CustomerSide
{
    public partial class Cust_Profile : System.Web.UI.Page
    {
        ...
        protected void LinkBtnComplaints_Click(object sender, EventArgs e)
        {
            string CustomerID = Request.QueryString["CustomerID"];
            Response.Redirect("Complaints.aspx?CustomerID=" + CustomerID);
        }

        protected void LinkBtnCheckStatus_Click(object sender, EventArgs e)
        {
            string CustomerID = Request.QueryString["CustomerID"];
            Response.Redirect("CheckComplaintsStatus.aspx?CustomerID=" + CustomerID);
        }
