...
namespace OnlineBankingWebApplication.AdminSide
{
    public class Admin_Customer
    {
        ...
        public DataTable Cutomer_Display(int AccountNo)
        {
            SqlConnection cn = new SqlConnection(strcn);
            cn.Open();
        ...
        public void Delete_CustomerComplaintsList(int ComplaintsID)
        {
            SqlConnection cn = new SqlConnection(strcn);
            cn.Open();
            SqlCommand cmd = new SqlCommand("usp_DeleteCustomerComplaintsList", cn);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public void Delete_CustomerAccount(int AccountNo)
        {
            SqlConnection cn = new SqlConnection(strcn);
            cn.Open();
            SqlCommand cmd = new SqlCommand("usp_DeleteSelectedAccount", cn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("@AccountNo", AccountNo);
            cmd.ExecuteNonQuery();
            cn.Close();
